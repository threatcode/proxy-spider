...
from proxy_spider import fs, sort
from proxy_spider.http import get_response_text
from proxy_spider.null_context import NullContext
from proxy_spider.parsers import parse_ipv4
from proxy_spider.utils import is_docker
...
class Settings:
    ...
    async def from_mapping(
        ...
        output_path = (
            platformdirs.user_data_path("proxy_spider")
